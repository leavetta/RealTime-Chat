...
namespace Chat.Web.Migrations
{
    ...
    [Migration("20220513153523_NewChatMember")]
    partial class NewChatMember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chat.Web.Models.ChatMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Chat.Web.Models.ChatMember", b =>
                {
                    b.HasOne("Chat.Web.Models.Room", "RoomId")
                        .WithMany()
                        .HasForeignKey("RoomIdId");

                    b.HasOne("Chat.Web.Models.ApplicationUser", "UserId")
                        .WithMany()
